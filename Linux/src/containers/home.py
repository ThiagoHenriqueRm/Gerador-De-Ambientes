from Tools import *
from containers import python_venv
from containers import javascript_react
...
def Home():
    ...
    def open_Python_Venv():
        app.destroy()
        python_venv.Python_Venv()

    Python_venv = CTK.CTkButton(
        master  = FramePython, 
        command = open_Python_Venv,
        text    = "PYTHON VENV", 
        font    = FONTE,
        height  = 35,
